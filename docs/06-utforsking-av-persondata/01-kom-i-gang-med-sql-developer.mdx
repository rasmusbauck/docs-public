...
De fleste velegnede programmer for utforsking og analyse krever at man klarer å installere programmer selv i sitt virtuelle skrivebord (VDI). Mange programmer er allerede godkjent for bruk i VDI, slik at de kan installeres fra personlige brukere, mens andre krever at man har bestilt og fått en test- og utviklingsbruker (TOU-bruker). Vet du at du har behov for spesiell software kan det være lurt å bestille en TOU-bruker først som sist, da det kan ta litt tid før det kommer på plass. I mellomtiden vil det ofte gi mening å begynne med Oracle SQL Developer, siden dette programmet kan bestilles i Programportalen uten at det trengs en TOU-bruker.
