...
Om du ikke allerede har en VDI kan dette bestilles gjennom POB. Husk å be om rollen "utvikler" når du bestiller din VDI om den skal brukes til analyse eller utviklingsformål, da dette gir tilgang til å installere blant annet Jupyter Notebooks.

Vet du at du har behov for spesiell software kan det være lurt å bestille en TOU-bruker først som sist, da det kan ta litt tid før det kommer på plass. I mellomtiden vil det ofte gi mening å begynne med Oracle SQL Developer uansett, da dette er en enkel måte å utforske databasen og dine tilganger.
...
[Gå til wiki-siden (må være på SVV-nett eller i VDI)](https://www.vegvesen.no/wiki/x/NReACw)
...
<VideoPlayer source="//storage.googleapis.com/saga-docs-prod_public-assets/Basic-bruk-av-sql-developer.webm" type="video/webm" width="720px" />
